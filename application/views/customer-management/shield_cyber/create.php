						...
						<div class="col-md-12">
							<div class="form-group<?php echo form_error('hostname') ? ' has-error':''; ?>">
								...
								<div class="input-group">
									...
									<input type="text" class="form-control" id="hostname" name="hostname" placeholder="api.shieldcyber.io" value="<?php echo set_value('hostname'); ?>">
								</div>
							</div>
							<div class="form-group<?php echo form_error('subscription_id') ? ' has-error':''; ?>">
								...
								<input type="text" class="form-control" id="subscription_id" name="subscription_id" placeholder="Enter Subscription ID" value="<?php echo set_value('subscription_id'); ?>">
							</div>
